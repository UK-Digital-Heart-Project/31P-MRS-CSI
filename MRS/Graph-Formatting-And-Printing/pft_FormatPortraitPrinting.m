function pft_FormatPortraitPrinting(HandleToFigure, HandleToAxes)
...
set(HandleToFigure, 'PaperOrientation', 'portrait');
set(HandleToFigure, 'Position', Position);
set(HandleToFigure, 'PaperPosition', [Edge, Edge, A4WD - 2.0*Edge, A4HT - 2.0*Edge], 'PaperUnits', 'centimeters');

xt = get(HandleToAxes, 'XTick');
set(HandleToAxes, 'FontSize', 16);
