function [ MES1, BES1, MES2, BES2, DCStats1, DCStats2, DCMeanStats ] = pft_AnalyzeOneStudySpecial(Folder, ScannerID, SubjectID)
...
% Find a single .IMA file from the series of 197 spectra and the function will automatically import the rest.
homeDir = pwd;
...
dc_off = mean( real( fids( end - 19 : end, : ) ) ); % Use last 20 pts for offset
