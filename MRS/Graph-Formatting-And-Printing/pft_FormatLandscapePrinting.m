function pft_FormatLandscapePrinting(HandleToFigure, HandleToAxes)
...
set(HandleToFigure, 'PaperPosition', [Edge, Edge, A4HT - 2.0*Edge, A4WD - 2.0*Edge], 'PaperUnits', 'centimeters');
